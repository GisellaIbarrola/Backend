...
(async () => {
  switch (PERSISTENCE) {
    case 'MONGO':
      ...
      productsDao.updateById = productsMongoPersistance.updateById
      productsDao.deleteById = productsMongoPersistance.deleteById
      ...
      userDao.getAll = userMongoPersistance.getAll
      userDao.deletedByID = userMongoPersistance.deletedByID
      break
    case 'MEMORY':
      ...
      productsDao.updateById = productsMemory.updateById
      productsDao.deleteById = productsMemory.deleteById
